...
class NoSuchTaskException : public common::TException {};

class UncancellableTaskException : public common::TException {};

class InvalidArgumentException : public common::TException {};

class IllegalStateException : public common::TException {
public:
  IllegalStateException() {}
  IllegalStateException(const std::string& message) : TException(message) {}
};

class TimedOutException : public common::TException {
public:
  TimedOutException() : TException("TimedOutException"){};
  TimedOutException(const std::string& message) : TException(message) {}
};

class TooManyPendingTasksException : public common::TException {
public:
...
class SystemResourceException : public common::TException {
public:
